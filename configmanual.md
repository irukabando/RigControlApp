...
| キー名 | 設定例 | 設定の基準と詳細な役割 |
| --- | --- | --- |
| **`Type`** | `ASCII` | 通信プロトコルの種別を指定します。<br><br>**`ASCII`**: テキスト形式のCATコマンド体系。Kenwood全般、およびYaesuのASCII CAT対応機（近年の主要機種）で使用。<br>**`CIV`**: Icom独自のバイナリパケットフレーム体系。<br>**`YaesuBinary`**: Yaesuの旧型5バイト固定バイナリ体系（FT-1000, FT-1000MP, Mark-V 等）。 |
